...
import static io.github.yizhiru.thulac4j.SPChineseTokenizerTest.POS_FEATURES_PATH;
import static io.github.yizhiru.thulac4j.SPChineseTokenizerTest.POS_WEIGHTS_PATH;
import static io.github.yizhiru.thulac4j.SegmenterTest.SENTENCES;
import static org.junit.Assert.assertEquals;

public class POSTaggerTest {

    @Test
    public void tagging() throws IOException {
        String[] expectedResults = new String[]{
                ...
                "本报/r 讯/g 深圳市/ns 海王/nz 生物/n 工程/n 股份/n 有限公司/n 二○○○/m 年度/n 增/v 发/v A/x 股/n 路/n 演/v 推介会/n 日前/t 在/p 北京/ns 举行/v",
                "共同/d 创造/v 美好/a 的/u 新/a 世纪/n ——/w 2001年/t 新年/t 贺词/n",
        };

        POSTagger posTagger = new POSTagger(POS_WEIGHTS_PATH, POS_FEATURES_PATH);
        posTagger.enableTitleWord();
